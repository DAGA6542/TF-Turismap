...
public class NegocioImplement implements INegocioService {
    ...
    public void delete(Long idNegocio) {
        nR.deleteById(idNegocio);
    }
    @Override
    public List<Negocio> obtenerPorCiudad(Long idCiudad) {
        return nR.obtenerPorCiudad(idCiudad);
    }
    @Override
    ...
    @Override
    public List<String[]> negocioMasPopularPorCalificacion() { return nR.negocioMasPopularPorCalificacion(); }
    @Override
    public List<String[]> calificacionPromedioNegocioPorCiudad() { return nR.calificacionPromedioNegocioPorCiudad(); }
}
