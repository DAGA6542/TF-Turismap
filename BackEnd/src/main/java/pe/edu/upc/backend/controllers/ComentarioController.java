...
public class ComentarioController {
    ...
    @GetMapping("/obtenercomenusuario")
    ...
    @GetMapping("/obtenercomennegocio")
    public List<ComentarioDTO> buscarComentariosPorNegocio(int idNegocio) {
    ...
    @GetMapping("/obtenercomenturismo")
    public List<ComentarioDTO> buscarComentariosPorTurismo(int idTurismo) {
    ...
    public List<ComentarioDTO> obtenerComentariosHastaFecha(LocalDate fecha) {
    ...
    public List<ComentarioDTO> buscarComentario(String texto) {
