...
public interface IDepartamentoRepository extends JpaRepository<Departamento, Integer> {
    ...
    public List<Departamento> buscarPorNombre(@RequestParam("nombre") String nombre);
    // Listar departamento por pais
    @Query("Select d from Departamento d where d.idPais.idPais = :idPais")
    public List<Departamento> listarPorPais(@RequestParam("idPais") int idPais);
    ...
    public List<Departamento> obtenerDepartamentPoblac(@RequestParam("poblacion") Long poblacion);
    ...
    public List<Departamento> buscarDepartamentoConSuperficie(@RequestParam("minSuperficie") int minSuperficie, @RequestParam("maxSuperficie") int maxSuperficie);
    ...
    public List<Departamento> buscarPorCapital(@RequestParam("capital") String capital);
}